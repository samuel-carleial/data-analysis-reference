...
Note: the propensity score will be saved inside df as variable ".fitted", among others things.

```{r, eval = TRUE}
head(unlist(df$.fitted))
```
...
# alternative 1
# par(mfrow=c(1,2))
# hist(unlist(df[df$qsmk==0, ".fitted"]), ylim = c(0,400), xlim = c(0,1))
# hist(unlist(df[df$qsmk==1, ".fitted"]), ylim = c(0,400), xlim = c(0,1))
# alternative 2
