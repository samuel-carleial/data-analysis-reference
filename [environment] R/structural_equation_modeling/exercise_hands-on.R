...
# de análise de caminhos contendo três fatores latentes de capacidade mental 
# (visual, textual e velocidade). As variáveis latentes devem explicar as pontuações 
# de diferentes disciplinas. Adicione variáveis de controle como idade e sexo no modelo.
